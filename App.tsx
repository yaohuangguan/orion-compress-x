...
import { Layers, Image as ImageIcon, Video, Menu, X, Globe, Aperture } from 'lucide-react';
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center gap-2">
                ...
                <span className="font-bold text-xl tracking-tight text-slate-900">{t.nav.appName}</span>
              </div>
            </div>
